...
- **Supabase:** project `zrftjkghhjhqzopvdzou` | טבלאות `kp_*` — ⚠️ **הפרויקט
...
- **הלקוח והצורך:** ניהול צדקה אישי-משפחתי — שני משתמשים על נתונים
  משותפים, ⛔ בלי כניסה. ⚠️ החישוב נוהל בגיליון, ושם טעות בחודש אחד
  נגררה חצי שנה: ⭐ ולכן **אף סיכום אינו נשמר**, וכל מספר נגזר
  מהרישומים בזמן קריאה.
