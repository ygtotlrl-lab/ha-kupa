...
const APP = {
  ...
  namePolicy: {
    ...
    msgAllow: {
      K_CAT_SELF: 'שם קטגוריית הצדקה האישית — ⛔ נתון בטבלה ולא הודעה, ⚠️ והוא נשמר על הרישום',
    },
    fnAllow: {},
    ...
    appTokens: {
      '--col': 'רוחב עמודת התוכן — ⛔ ואין בשאר עמודה ברוחב קצוב שמתרחב בנקודות השבירה',
      '--line-soft': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--on-rasp': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--peach-1': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--peach-2': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--purple-1': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--purple-2': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--purple-3': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--purple-4': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--purple-5': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--purple-6': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--purple-7': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--rasp': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--rasp-ink': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
      '--ring-soft': 'גוון מוצר של מסך שקיים כאן בלבד — ⛔ ואין לו תפקיד באחיות',
    },
    ...
    slotTokens: {
      '--cf-c': 'גוון הקונפטי שנכתב ב-setProperty בזמן ריצה',
      '--cf-x': 'מיקום אופקי שנכתב ב-setProperty בזמן ריצה',
      '--cf-y': 'מיקום אנכי שנכתב ב-setProperty בזמן ריצה',
    },
  },
};
/* ── סוף APP ───────────────────────────────────────────────────────────── */
