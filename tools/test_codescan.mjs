...
const APP = {
  ...
  appFns: {
    ...
    monthLabel:
      'מתרגמת מפתח `YYYY-MM` לתווית חודש ושנה בעברית — וביומן ובהנהלה אין חודש שהוא מפתח נתונים',
    saveTxn:
      'שומרת תנועת גבייה מול תורם ומול התחייבות, מקומית-תחילה — וביומן ובהנהלה אין תנועות כספים',
    saveUser:
