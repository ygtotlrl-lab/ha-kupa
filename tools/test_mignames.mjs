...
const APP = {
  ...
  migrations: {
    '000_initial_schema.sql': 'kp_001_kupa_schema',
    '001_updated_at_bigint.sql': 'kp_updated_at_bigint',
    ...
    '006_so_instances_drop_status.sql': 'kupa_so_instances_drop_status',
    '007_so_instances_future_soft_delete.sql': 'kupa_so_instances_future_soft_delete',
  },
  ...
  migRanNoFile: {
    'keepalive_heartbeat': 'טבלת placeholder שנוצרה כדי שהפרויקט לא יושהה — ⛔ ואין לה קובץ',
    'drop_heartbeat_placeholder': 'מחיקת אותה טבלה — ⛔ ואין לה קובץ',
    'gius_0004_backup_log': 'ההרצה הראשונה של אותו קובץ, בשחזור שגוי — ⚠️ והשנייה היא שתואמת לו',
    'kp_002_grants_rls': 'ההרשאות וה-RLS רצו כרשומה נפרדת — ⚠️ ותוכנן יושב בקובץ הסכימה',
  },
};
/* ── סוף APP ───────────────────────────────────────────────────────────── */
