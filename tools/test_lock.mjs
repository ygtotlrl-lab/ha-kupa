...
const APP = {
  app: 'ha-kupa',
  file: 'index.html',
  /*  ⛔ `present:false` הוא הצהרה מנומקת ולא היעדר שקט — ⚠️ שני משתמשים
   *  ונתונים משותפים, ⛔ ואין כאן מסך כניסה, אין משתמש מחובר, ואין מה
   *  לנעול: ⭐ נעילה בלי מי לנעול היא מסך שחוסם את כולם באותה מידה. */
  present: false,
  /*  ⛔ עם `present:false` ארבע הטענות כאן הן טענות-חסר, ⛔ ובלוק
   *  המוטציות מדולג — ⚠️ אין ליבה שאפשר למוטט. ⭐ המוטציות רצות
   *  בשלוש האפליקציות שיש בהן נעילה, ⛔ ולא כאן. */
  bootFn:  'kpBoot',        // פונקציית העלייה — נקודת ההפעלה היחידה
  resetFn: null,
  stopFn:  null,
