...
const APP = {
  ...
  appClasses: {
    'back':
      'כפתור החזרה בקופה הוא אייקון בגודל יעד מגע — המסך כאן מיועד לשימוש ביד אחת, ויעד קטן ממנו אינו נלחץ — ⚠️ מוצהרת **עד יישור שכבת האסימונים**',
    'btn':
      'כפתור בקופה נפרש לרוחב המסך — הוא הפעולה היחידה בתחתית המסך, וכפתור צר לצידו היה מזמין לחיצה שגויה — ⚠️ מוצהרת **עד יישור שכבת האסימונים**',
    'btrack':
      'פס ההתקדמות בקופה נושא את גוון הרקע של הזהות — הוא הרכיב המרכזי במסך הבית, והגוון הוא מה שמבדיל בין שני הפסים — ⚠️ מוצהרת **עד יישור שכבת האסימונים**',
    'card':
      'כרטיס בקופה נושא ריווח תחתון קטן — מסך הבית הוא ערימת כרטיסים קצרה שנכנסת למסך אחד בלי גלילה — ⚠️ מוצהרת **עד יישור שכבת האסימונים**',
    'fab':
      'כפתור הפעולה הצף בקופה יושב בקצה המתחיל ובלי סרגל תחתון מתחתיו — אין כאן ניווט תחתון, והאגודל מגיע לפינה — ⚠️ מוצהרת **עד יישור שכבת האסימונים**',
    'fld':
      'שדה בקופה הוא בלוק עם ריווח תחתון גדול — הטופס כאן קצר ומיועד להקלדה מהירה של סכום — ⚠️ מוצהרת **עד יישור שכבת האסימונים**',
    'veil':
      'מסך ההעמעמה בקופה ממרכז את הדיאלוג ומשאיר לו ריווח מסביב — הדיאלוג כאן הוא אישור קצר, וגיליון תחתון היה מותיר חצי מסך ריק — ⚠️ מוצהרת **עד יישור שכבת האסימונים**',
  },
};
/* ── סוף APP ───────────────────────────────────────────────────────────── */
