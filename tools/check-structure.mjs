...
const APP = {
  ...
  toolsExtra: {
    ...
    'kp_calc.mjs': 'ליבת חישוב החומש, היתרה והמילוי — ⛔ אף סיכום אינו נשמר, ⚠️ והכל נגזר מהרישומים בזמן קריאה: ⭐ ולשאר אין שרשרת חודשים שנגזרת',
  },
...
/* ⚠️ פר-אפליקציה — רתמת מודל ההרשאות קיימת בשלוש שיש בהן כניסה, וכאן אין כניסה ואין תפקיד שיוכרע */
const MODULES = SHARED_MODULES;
/* ⚠️ סוף פר-אפליקציה */
