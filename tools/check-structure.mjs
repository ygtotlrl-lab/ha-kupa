...
const APP = {
  ...
  toolsExtra: {
    ...
    'gen-icons.mjs': 'מחולל האייקונים (PWA + APK) — פרטי ל-gius; באחיות האייקונים נגזרים מקובצי מאסטר גרפיים',
...
const FLOOR = { shared: 14, app: 1, appWhy: 'מחולל האייקונים כחריגת tools — מוצהר פרטי בגיוס בלבד' };
/* ⚠️ סוף פר-אפליקציה */
