...
const APP = {
  ...
  fgInk: [255, 255, 255],
  tileFlat: 'האריח כאן הוא ריבוע מעוגל בצבע מלא ועליו קופת מטבעות — גוף הקופה, חריץ ומטבע — ⛔ הדיו הוא הרקע',
...
const FLOOR = { shared: 22, app: 4, appWhy: 'אין מאסטר רסטרי — הצהרת היעדרו נמדדת בשתי הרמות, וההזזה עצמה היא מוטציה' };
/* ⚠️ סוף פר-אפליקציה */
