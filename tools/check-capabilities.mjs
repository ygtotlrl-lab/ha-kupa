...
const APP = {
  ...
  gapRows: [230, 82, 150, 175, 186, 160, 102, 74, 75, 176, 194, 195, 196, 197, 198, 200, 202],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    198: (c) => c.hasCode(/G_PASS_ITER\s*=\s*100000\b/)
