...
const APP = {
  ...
  gapRows: [45, 75, 122, 124, 128, 152, 162, 137, 90, 66, 67, 68, 119, 153, 168, 169, 170, 171, 172, 173, 174, 175, 177],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    173: (c) => c.hasCode(/G_PASS_ITER\s*=\s*100000\b/)
