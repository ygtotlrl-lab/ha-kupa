...
const APP = {
   ...
   *  רשומה ⛔ ולא לסחיפה. */
  appTokens: {
    '--col': 'רוחב עמודת התוכן — ⚠️ המסך, סרגל הלשוניות ומסילת הכפתור הצף קוראים אותו, ⭐ ואין בשאר עמודה ברוחב קצוב שמתרחב בנקודות השבירה',
  ...
  gapRows: [227, 81, 143, 145, 149, 173, 184, 158, 101, 72, 73, 74, 140, 174, 191, 192, 193, 194, 195, 196, 197, 198, 200],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    196: (c) => c.hasCode(/G_PASS_ITER\s*=\s*100000\b/)
...
const FLOOR = { shared: 91, app: 5, appWhy: 'שכבת המראה ושני בלוקי גרף העמודות; ומעליהם מנוע התאריך העברי — ⛔ ואין כאן שכבת כניסה' };
/* ⚠️ סוף פר-אפליקציה */
