...
const APP = {
  ...
  /*  ⛔ אין כאן מסך התקנה — ההתקנה נעשית מ-`migrations/` בלוח
   ...
   *  נשמט: ⭐ שדה חסר נקרא «לא נשאל», וריק נקרא «נמדד ואין». */
  secretField: null,
  /*  ⛔ אין כאן מסלול השלמת טביעה — ⚠️ כתיבת משתמש דורשת רשת
  ...
  gapRows: [228, 82, 150, 175, 186, 160, 102, 74, 75, 176, 194, 195, 196, 197, 198, 200, 202],
...
/*  ⭐ נעילת חוסר-פעילות. ה-probe דורש את **שני** התנאים:
  ...
  { row: 194, name: 'שכבת כניסה מלאה',
    /*  ⛔ ההיקף הוא מפת הפעולות — ⚠️ שם פעולה שחי מחוץ למפה
