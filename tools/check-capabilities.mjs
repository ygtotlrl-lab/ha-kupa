...
const APP = {
  ...
  gapRows: [48, 80, 129, 131, 135, 159, 169, 144, 95, 71, 72, 73, 126, 160, 175, 176, 177, 178, 179, 180, 181, 182, 184],
  ...
  tableProbe: {
     ...
     *  ניתנת למדידה במלואה. */
    180: (c) => c.hasCode(/G_PASS_ITER\s*=\s*100000\b/)
...
const FLOOR = { shared: 86, app: 5, appWhy: 'שכבת המראה ושני בלוקי גרף העמודות; ומעליהם מנוע התאריך העברי — ⛔ ואין כאן שכבת כניסה' };
/* ⚠️ סוף פר-אפליקציה */
