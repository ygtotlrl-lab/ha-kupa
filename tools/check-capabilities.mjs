...
const APP = {
  ...
  appTokens: {
    ...
    '--peach-3': 'דיו האפרסק על משטח רך — הדרגה הכהה בסולם, ואין בשאר סולם כזה',
  ...
  dualRoleAllow: {
    ...
    '--ok-soft': 'הדיו של סיווג ההצלחה בטוסט והמשטח שלו בהמחשת היעד — ⚠️ צמד הפוך שמתחלף יחד, ⭐ והיחס נמדד עובר בשני המצבים',
  },
  ...
  enterFields: ['f-amount', 'f-desc', 'f-date', 'o-amt', 'o-name', 'o-day',
                'e-amt', 'e-desc', 'e-date', 'p-amt'],
  enterExempt: [],
  ksaveActs: ['flow-next', 'entry-save', 'order-new', 'order-save', 'pledge-save'],
