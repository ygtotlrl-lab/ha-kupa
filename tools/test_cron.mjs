...
/* ⭐ kupa חולקת את הפרויקט `zrftjkghhjhqzopvdzou` עם gius, ⛔ והמיגרציה של
   רשימת-ההיתר יושבת בריפו של gius — ⚠️ ולכן `migration` הוא `null` כאן,
   ⭐ ו-`sisterKeys` ריקה: מפתחות האחות כבר ברשימה שהיא מגדירה. */
/* ⚠️ סוף פר-אפליקציה */
const APP = {
