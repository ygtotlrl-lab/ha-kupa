...
const APP = {
  app: 'gius',
  file: 'index.html',
  /*  ⭐ `runSave` היא המעטפת, ו-`busy` הוא מה שהיא מפעילה — ⚠️ הבדיקה
   *  היא על `busy` מפני שגם המסלולים שאינם עוברים ב-`runSave`
   *  (`switch-confirm`, `doLoginOffline`) קוראים לו ישירות. */
  busyFn: 'busy',
  guardReason: null,
