...
const APP = {
   ...
   *  השורה השתנתה. */
  dataEra: { base: 1, era: 3, why: 'העמודה `status` ירדה מ-`k_so_instances` (סבב 163) — ⚠️ שורה מקומית שלא נדחפה עוד נושאת אותה: ⛔ והדחיפה נופלת ב-`42703` על עמודה שאינה קיימת, ⭐ וחוסמת את התור כולו' },
  ...
  merge: (sb, local, remote) => sb.mergeRows(local, remote, 'id', (k) => sb.pendIs(k)),
