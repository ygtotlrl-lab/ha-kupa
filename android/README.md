...
| **versionCode** | 3 — קודם בסבב 148 (המאסטר `design/icon-master.svg` הוא מקור האייקון: המחולל קורא אותו וגוזר ממנו, ו-16 הנכסים נוצרו מחדש). 2 — קודם בסבב 147 (שם האפליקציה במעטפת וגוון הזהות יושרו לאפליקציה הזו). 1 — המעטפת הראשונה. ⛔ versionCode לעולם אינו יורד — מספר נמוך ממה שמותקן במכשיר חוסם את העדכון |
